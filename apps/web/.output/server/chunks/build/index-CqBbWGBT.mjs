...
import { a as useSeoMeta, b as useChatStore, d as useRoute, e as useRouter, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full flex flex-col items-center justify-center px-4 py-10 relative" }, _attrs))} data-v-3324ed1d><div class="relative z-10 mb-6 animate-fade-in text-center" data-v-3324ed1d><div class="relative inline-block mb-5 animate-float" data-v-3324ed1d><div class="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto" style="${ssrRenderStyle({ "background": "rgba(255,255,255,0.07)", "border": "1px solid rgba(255,255,255,0.12)", "box-shadow": "0 8px 32px rgba(0,0,0,0.4), 0 0 0 1px rgba(255,255,255,0.04) inset" })}" data-v-3324ed1d><svg width="26" height="26" viewBox="0 0 24 24" fill="none" style="${ssrRenderStyle({ "color": "#F0F0F0" })}" data-v-3324ed1d><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" fill="currentColor" data-v-3324ed1d></path></svg></div><div class="absolute inset-0 rounded-2xl blur-xl opacity-20 -z-10" style="${ssrRenderStyle({ "background": "radial-gradient(circle, rgba(59,130,246,0.7), transparent)" })}" data-v-3324ed1d></div></div><h1 class="text-[1.85rem] font-bold mb-2" style="${ssrRenderStyle({ "color": "#F0F0F0", "letter-spacing": "-0.03em", "line-height": "1.2" })}" data-v-3324ed1d> Tell Autobot what you need. </h1><p class="text-[15px]" style="${ssrRenderStyle({ "color": "#464646" })}" data-v-3324ed1d>Consider it done.</p></div><div class="relative z-10 w-full max-w-xl mb-5 animate-fade-in" style="${ssrRenderStyle({ "animation-delay": "0.06s" })}" data-v-3324ed1d><div class="${ssrRenderClass([unref(inputFocused) ? "ring-1 ring-white/18" : "", "flex items-end gap-2 transition-all duration-150"])}" style="${ssrRenderStyle({ "background": "rgba(255,255,255,0.05)", "border": "1px solid rgba(255,255,255,0.09)", "border-radius": "16px", "padding": "10px 10px 10px 16px", "backdrop-filter": "blur(8px)" })}" data-v-3324ed1d><textarea rows="1" class="flex-1 bg-transparent resize-none outline-none text-sm leading-relaxed max-h-32" style="${ssrRenderStyle({ "color": "#F0F0F0", "caret-color": "#F0F0F0" })}" placeholder="Tanya apa saja tentang Autobot..." data-v-3324ed1d>${ssrInterpolate(unref(input))}</textarea><button${ssrIncludeBooleanAttr(!unref(input).trim()) ? " disabled" : ""} class="${ssrRenderClass([unref(input).trim() ? "hover:scale-105 active:scale-95" : "cursor-not-allowed", "w-8 h-8 rounded-xl flex items-center justify-center shrink-0 transition-all duration-150"])}" style="${ssrRenderStyle(unref(input).trim() ? "background: #F0F0F0; color: #111;" : "background: rgba(255,255,255,0.08); color: rgba(255,255,255,0.2);")}" data-v-3324ed1d><svg width="15" height="15" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" data-v-3324ed1d><path d="M5 10h10M11 6l4 4-4 4" data-v-3324ed1d></path></svg></button></div><p class="text-center mt-2 text-[11px] select-none" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.16)" })}" data-v-3324ed1d> Enter untuk kirim \xA0\xB7\xA0 Shift+Enter baris baru </p></div><div class="relative z-10 w-full max-w-xl grid grid-cols-2 gap-2 animate-fade-in" style="${ssrRenderStyle({ "animation-delay": "0.1s" })}" data-v-3324ed1d><!--[-->`);
      ssrRenderList(suggestions, (s) => {
        _push(`<button class="${ssrRenderClass([s.accent ? "suggestion-card--accent" : "", "suggestion-card group"])}" data-v-3324ed1d><div class="flex items-start gap-2.5" data-v-3324ed1d><span class="text-base mt-0.5 shrink-0 leading-none" data-v-3324ed1d>${ssrInterpolate(s.icon)}</span><span class="text-[13px] font-medium leading-snug" style="${ssrRenderStyle(s.accent ? "color: #a5b4fc;" : "color: #6A6A6A;")}" data-v-3324ed1d>${ssrInterpolate(s.text)}</span></div></button>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-3324ed1d"]]);
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-2xl animate-scale-in" }, _attrs))} data-v-f992fd44>`);
      if (__props.data.title) {
        _push(`<p class="text-sm text-gray-400 mb-3" data-v-f992fd44>${ssrInterpolate(__props.data.title)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex gap-3 overflow-x-auto pb-2 snap-x scrollbar-hide" data-v-f992fd44><!--[-->`);
      ssrRenderList(__props.data.items, (item) => {
        _push(`<div class="flex-shrink-0 w-52 rounded-2xl border border-white/10 bg-white/5 p-4 cursor-pointer hover:border-white/25 hover:bg-white/8 transition-all snap-start group" data-v-f992fd44>`);
        if (item.image) {
          _push(`<div class="w-full h-28 rounded-xl bg-white/10 mb-3 overflow-hidden" data-v-f992fd44><img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.name)} class="w-full h-full object-cover" data-v-f992fd44></div>`);
        } else {
          _push(`<div class="w-full h-28 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 mb-3 flex items-center justify-center text-3xl" data-v-f992fd44>${ssrInterpolate(getCategoryEmoji(item.category))}</div>`);
        }
        _push(`<h4 class="text-white font-medium text-sm group-hover:text-blue-300 transition-colors" data-v-f992fd44>${ssrInterpolate(item.name)}</h4><p class="text-gray-500 text-xs mt-1 line-clamp-2" data-v-f992fd44>${ssrInterpolate(item.tagline)}</p></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const RichProductCarousel = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-f992fd44"]]);
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-2xl animate-scale-in" }, _attrs))} data-v-e6b227ab>`);
      if (__props.data.product) {
        _push(`<p class="text-sm text-gray-400 mb-3" data-v-e6b227ab>Harga ${ssrInterpolate(__props.data.product)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex gap-3 overflow-x-auto pb-2 scrollbar-hide" data-v-e6b227ab><!--[-->`);
      ssrRenderList(__props.data.tiers, (tier) => {
        _push(`<div class="${ssrRenderClass([tier.highlighted ? "border-blue-500/50 bg-blue-500/10" : "border-white/10 bg-white/5", "flex-shrink-0 w-52 rounded-2xl border p-4 transition-all"])}" data-v-e6b227ab>`);
        if (tier.highlighted) {
          _push(`<div class="text-xs text-blue-400 font-medium mb-2" data-v-e6b227ab>\u2B50 Populer</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<h4 class="text-white font-semibold" data-v-e6b227ab>${ssrInterpolate(tier.name)}</h4><div class="mt-2 mb-3" data-v-e6b227ab><span class="text-2xl font-bold text-white" data-v-e6b227ab>${ssrInterpolate(tier.price)}</span><span class="text-gray-500 text-sm ml-1" data-v-e6b227ab>/ ${ssrInterpolate(tier.period)}</span></div><ul class="space-y-1.5 mb-4" data-v-e6b227ab><!--[-->`);
        ssrRenderList(tier.features, (f) => {
          _push(`<li class="flex items-start gap-1.5 text-xs text-gray-400" data-v-e6b227ab><span class="text-green-400 mt-0.5" data-v-e6b227ab>\u2713</span> ${ssrInterpolate(f)}</li>`);
        });
        _push(`<!--]--></ul><button class="${ssrRenderClass([tier.highlighted ? "bg-blue-500 text-white hover:bg-blue-400" : "border border-white/15 text-gray-400 hover:text-white hover:border-white/30", "w-full py-2 rounded-xl text-xs font-medium transition-colors"])}" data-v-e6b227ab> Pilih ${ssrInterpolate(tier.name)}</button></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const RichPricingTable = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-e6b227ab"]]);
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><button class="w-full py-2.5 rounded-xl text-sm font-semibold transition-all mt-1" style="${ssrRenderStyle({ "background": "linear-gradient(135deg, #a855f7, #6366f1)", "color": "white", "cursor": "pointer", "box-shadow": "0 4px 14px rgba(168,85,247,0.35)" })}"> Setuju &amp; Bayar Sekarang \u2192 </button><button class="w-full py-2.5 rounded-xl text-sm font-semibold transition-all" style="${ssrRenderStyle({ "background": "rgba(255,255,255,0.06)", "color": "rgba(255,255,255,0.88)", "border": "1px solid rgba(255,255,255,0.10)" })}"> Jadwalkan via Google Calendar </button><button class="w-full text-xs text-center py-1 transition-opacity hover:opacity-70" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.30)" })}"> Tanya dulu sebelum bayar </button></div></div>`);
    };
  }
});
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex gap-2 overflow-x-auto pb-1 scrollbar-hide" }, _attrs))} data-v-60daa44d><!--[-->`);
      ssrRenderList(__props.suggestions, (s, i) => {
        _push(`<button style="${ssrRenderStyle(getStyle(s.category))}" class="${ssrRenderClass([{ "animate-slide-up": true }, "flex-shrink-0 flex items-center gap-2.5 px-3.5 py-2 rounded-xl transition-all text-left group"])}"${ssrRenderAttr("data-delay", i * 40)} data-v-60daa44d><span class="text-base leading-none" data-v-60daa44d>${ssrInterpolate(getEmoji(s.category))}</span><span class="text-[12.5px] font-medium whitespace-nowrap" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.70)" })}" data-v-60daa44d>${ssrInterpolate(s.text)}</span></button>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-60daa44d"]]);
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col h-full relative overflow-hidden" }, _attrs))} data-v-482c219d>`);
      if (!unref(chatStore).hasStarted) {
        _push(`<div class="absolute inset-0 pointer-events-none z-0" data-v-482c219d><div class="absolute inset-0" style="${ssrRenderStyle({ "background": "radial-gradient(ellipse 90% 70% at 50% 50%, rgba(59,130,246,0.07) 0%, transparent 65%)" })}" data-v-482c219d></div><div class="absolute inset-0" style="${ssrRenderStyle({ "background": "radial-gradient(ellipse 60% 40% at 50% 20%, rgba(99,102,241,0.05) 0%, transparent 60%)" })}" data-v-482c219d></div><div class="absolute inset-0" style="${ssrRenderStyle({ "background": "radial-gradient(ellipse 60% 35% at 50% 85%, rgba(59,130,246,0.04) 0%, transparent 55%)" })}" data-v-482c219d></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(chatStore).hasStarted) {
        _push(`<div class="flex-1 flex flex-col items-center justify-center relative z-10" data-v-482c219d>`);
        _push(ssrRenderComponent(_component_ChatWelcome, {
          onSend: ($event) => _ctx.$emit("send", $event)
        }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="flex-1 flex flex-col min-h-0 relative z-10" data-v-482c219d><div class="flex-1 overflow-y-auto px-4 py-6 space-y-5" data-v-482c219d><!--[-->`);
        ...
        _push(`<div class="h-1" data-v-482c219d></div></div>`);
        if (unref(chatStore).suggestions.length && !unref(chatStore).isTyping) {
          _push(`<div class="px-4 pb-2 shrink-0" data-v-482c219d>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-482c219d"]]);
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    ref(null);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-4 pb-5 pt-2" }, _attrs))} data-v-8b4bdd16><div class="${ssrRenderClass([unref(isFocused) ? "ring-1 ring-white/20" : "", "flex items-end gap-2 transition-all duration-150"])}" style="${ssrRenderStyle({ "background": "rgba(255,255,255,0.05)", "border": "1px solid rgba(255,255,255,0.09)", "border-radius": "16px", "padding": "10px 10px 10px 16px", "backdrop-filter": "blur(8px)" })}" data-v-8b4bdd16><textarea class="flex-1 bg-transparent resize-none outline-none text-sm leading-relaxed max-h-32 chat-input" style="${ssrRenderStyle({ "color": "#F0F0F0", "caret-color": "#F0F0F0" })}"${ssrRenderAttr("placeholder", __props.placeholder || "Tanya apa saja tentang Autobot...")}${ssrIncludeBooleanAttr(__props.disabled) ? " disabled" : ""} rows="1" data-v-8b4bdd16>${ssrInterpolate(unref(input))}</textarea><button${ssrIncludeBooleanAttr(!unref(input).trim() || __props.disabled) ? " disabled" : ""} class="${ssrRenderClass([unref(input).trim() && !__props.disabled ? "text-[#111111] hover:scale-105 active:scale-95" : "cursor-not-allowed", "w-8 h-8 rounded-xl flex items-center justify-center shrink-0 transition-all duration-150"])}" style="${ssrRenderStyle(unref(input).trim() && !__props.disabled ? "background: #F0F0F0;" : "background: rgba(255,255,255,0.08); color: rgba(255,255,255,0.2);")}" data-v-8b4bdd16><svg width="15" height="15" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" data-v-8b4bdd16><path d="M5 10h10M11 6l4 4-4 4" data-v-8b4bdd16></path></svg></button></div><p class="text-center mt-2 text-[11px] select-none" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.18)" })}" data-v-8b4bdd16> Enter untuk kirim \xA0\xB7\xA0 Shift+Enter baris baru </p></div>`);
    };
  }
});
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-8b4bdd16"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
      ...
      switch (payload.type) {
        ...
        case "show_form":
          chatStore.addMessage({
            role: "user",
            content: `Saya ingin ${payload.form_type === "order" ? "order" : payload.form_type === "demo_request" ? "request demo" : payload.form_type === "consultation_booking" ? "jadwalkan konsultasi" : "konsultasi"}`
          });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-cf20760b><div class="flex flex-col min-h-0 transition-[width] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]" style="${ssrRenderStyle(unref(artifactStore).isOpen ? "width: 44%; min-width: 280px;" : "width: 100%;")}" data-v-cf20760b><div class="flex-1 overflow-hidden min-h-0" data-v-cf20760b>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cf20760b"]]);

export { index as default };
//# sourceMappingURL=index-CqBbWGBT.mjs.map

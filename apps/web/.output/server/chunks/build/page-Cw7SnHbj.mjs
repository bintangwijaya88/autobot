...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div></nav><main class="max-w-3xl mx-auto px-6 py-14">`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</main><footer class="px-6 pt-10 pb-8 text-[13px] mt-auto" style="${ssrRenderStyle({ "border-top": "1px solid rgba(255,255,255,0.06)", "color": "rgba(255,255,255,0.3)" })}"><div class="max-w-5xl mx-auto"><div class="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8"><div class="col-span-2 sm:col-span-1"><p class="text-white font-semibold mb-1 text-[14px]">Autobot Wijaya Solution</p><p class="text-xs leading-relaxed mb-3" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.3)" })}"> Spesialis chatbot WhatsApp &amp; AI automation untuk bisnis Indonesia. </p><p class="text-xs" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.25)" })}"> Jl. Raya Kebayoran Lama No. 12<br>Jakarta Selatan 12240, Indonesia </p></div><div><p class="text-white/60 text-xs font-semibold uppercase tracking-wider mb-3">Produk</p><ul class="space-y-2"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/products",
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Mulai Berlangganan`);
      } else {
        return [
          createTextVNode("Mulai Berlangganan")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</li></ul></div><div><p class="text-white/60 text-xs font-semibold uppercase tracking-wider mb-3">Perusahaan</p><ul class="space-y-2"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/about",
    class: "hover:text-white/60 transition-colors"
  }, {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Mitra &amp; Case Study`);
      } else {
        return [
          createTextVNode("Mitra & Case Study")
        ];
      }
    }),
    _: 1
  ...
  _push(`</li><li><a href="https://wa.me/6282164867681" target="_blank" rel="noopener" class="hover:text-white/60 transition-colors"> WhatsApp Admin </a></li></ul></div><div><p class="text-white/60 text-xs font-semibold uppercase tracking-wider mb-3">Legal</p><ul class="space-y-2"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/privacy-policy",
    class: "hover:text-white/60 transition-colors"
  }, {
...
//# sourceMappingURL=page-Cw7SnHbj.mjs.map

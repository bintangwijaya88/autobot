...
import { c as useRoute, i as createError, a as useSeoMeta, b as useRuntimeConfig } from './server.mjs';
import { u as useFetch } from './fetch-_CjskWJ2.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(product)) {
        ...
        _push(`<div class="mb-8"><h2 class="text-2xl font-bold text-white mb-4">Fitur Utama</h2><div class="grid grid-cols-1 md:grid-cols-2 gap-3"><!--[-->`);
        ...
        if ((_a2 = unref(product).pricing) == null ? void 0 : _a2.length) {
          _push(`<div class="mb-8"><h2 class="text-2xl font-bold text-white mb-4">Harga</h2><div class="flex gap-4 overflow-x-auto pb-2"><!--[-->`);
          ssrRenderList(unref(product).pricing, (tier) => {
            ...
            _push(`<!--]--></ul>`);
            if (tier.cta_url) {
              _push(`<a${ssrRenderAttr("href", tier.cta_url)} target="_blank" rel="noopener" class="block w-full py-2.5 rounded-xl text-sm font-semibold text-center transition-all hover:opacity-90" style="${ssrRenderStyle({ "background": "linear-gradient(135deg, #7c3aed, #2563eb)", "color": "white" })}"> Beli Sekarang \u2192 </a>`);
            } else {
...
//# sourceMappingURL=_slug_-izqjQ27a.mjs.map

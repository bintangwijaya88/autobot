...
const translatedMarketing: Record<Exclude<LocaleCode, 'en'>, typeof marketingEn> = {
  ...
  fil: {
    ...marketingEn,
    nav: { ...marketingEn.nav, product: 'Produkto', research: 'Pananaliksik', platforms: 'Mga Platform', solutions: 'Solusyon', technology: 'Teknolohiya', company: 'Kompanya', blog: 'Blog', bookConsultation: 'Mag-book ng Konsultasyon' },
    footer: { ...marketingEn.footer, brandDesc: 'Kompanya para sa AI, automation, at digital infrastructure para sa modernong negosyo.', company: 'Kompanya', companyProfile: 'Profile ng Kompanya', technology: 'Teknolohiya', useCases: 'Use Cases', platforms: 'Mga Platform', allPlatforms: 'Lahat ng Platform', resources: 'Resources', research: 'Pananaliksik', blog: 'Blog', privacy: 'Privacy Policy' },
    language: { label: 'Wika' },
  ...
  ms: {
    ...marketingEn,
    nav: { ...marketingEn.nav, product: 'Produk', research: 'Penyelidikan', platforms: 'Platform', solutions: 'Solusi', technology: 'Teknologi', company: 'Syarikat', blog: 'Blog', bookConsultation: 'Tempah Konsultasi' },
    footer: { ...marketingEn.footer, brandDesc: 'Syarikat AI, automasi, dan infrastruktur digital untuk perniagaan moden.', company: 'Syarikat', companyProfile: 'Profil Syarikat', technology: 'Teknologi', useCases: 'Kes Penggunaan', platforms: 'Platform', allPlatforms: 'Semua Platform', resources: 'Sumber', research: 'Penyelidikan', blog: 'Blog', privacy: 'Dasar Privasi' },
    language: { label: 'Bahasa' },
  ...
  vi: {
    ...marketingEn,
    nav: { ...marketingEn.nav, product: 'Sản phẩm', research: 'Nghiên cứu', platforms: 'Nền tảng', solutions: 'Giải pháp', technology: 'Công nghệ', company: 'Công ty', blog: 'Blog', bookConsultation: 'Đặt lịch tư vấn' },
    footer: { ...marketingEn.footer, brandDesc: 'Công ty AI, tự động hóa và hạ tầng số cho doanh nghiệp hiện đại.', company: 'Công ty', companyProfile: 'Hồ sơ công ty', technology: 'Công nghệ', useCases: 'Trường hợp sử dụng', platforms: 'Nền tảng', allPlatforms: 'Tất cả nền tảng', resources: 'Tài nguyên', research: 'Nghiên cứu', blog: 'Blog', privacy: 'Chính sách bảo mật' },
  ...
  km: {
    ...marketingEn,
    nav: { ...marketingEn.nav, product: 'ផលិតផល', research: 'ស្រាវជ្រាវ', platforms: 'វេទិកា', solutions: 'ដំណោះស្រាយ', technology: 'បច្ចេកវិទ្យា', company: 'ក្រុមហ៊ុន', blog: 'ប្លុក', bookConsultation: 'កក់ការប្រឹក្សា' },
    footer: { ...marketingEn.footer, brandDesc: 'ក្រុមហ៊ុន AI, ស្វ័យប្រវត្តិកម្ម និងហេដ្ឋារចនាសម្ព័ន្ធឌីជីថលសម្រាប់អាជីវកម្មទំនើប។', company: 'ក្រុមហ៊ុន', companyProfile: 'ប្រវត្តិក្រុមហ៊ុន', technology: 'បច្ចេកវិទ្យា', useCases: 'ករណីប្រើប្រាស់', platforms: 'វេទិកា', allPlatforms: 'វេទិកាទាំងអស់', resources: 'ធនធាន', research: 'ស្រាវជ្រាវ', blog: 'ប្លុក', privacy: 'គោលការណ៍ឯកជនភាព' },
    language: { label: 'ភាសា' },
  ...
  zh: {
    ...marketingEn,
    nav: { ...marketingEn.nav, product: '产品', research: '研究', platforms: '平台', solutions: '解决方案', technology: '技术', company: '公司', blog: '博客', bookConsultation: '预约咨询' },
    footer: { ...marketingEn.footer, brandDesc: '面向现代企业的 AI、自动化与数字基础设施公司。', company: '公司', companyProfile: '公司简介', technology: '技术', useCases: '用例', platforms: '平台', allPlatforms: '全部平台', resources: '资源', research: '研究', blog: '博客', privacy: '隐私政策' },
    language: { label: '语言' },
  ...
  ja: {
    ...marketingEn,
    nav: { ...marketingEn.nav, product: 'プロダクト', research: 'リサーチ', platforms: 'プラットフォーム', solutions: 'ソリューション', technology: 'テクノロジー', company: '会社', blog: 'ブログ', bookConsultation: '相談を予約' },
    footer: { ...marketingEn.footer, brandDesc: '現代企業向けのAI、自動化、デジタル基盤の会社です。', company: '会社', companyProfile: '会社概要', technology: 'テクノロジー', useCases: 'ユースケース', platforms: 'プラットフォーム', allPlatforms: 'すべてのプラットフォーム', resources: 'リソース', research: 'リサーチ', blog: 'ブログ', privacy: 'プライバシーポリシー' },
    language: { label: '言語' },
  ...
  th: {
    ...marketingEn,
    nav: { ...marketingEn.nav, product: 'สินค้า', research: 'วิจัย', platforms: 'แพลตฟอร์ม', solutions: 'โซลูชัน', technology: 'เทคโนโลยี', company: 'บริษัท', blog: 'บล็อก', bookConsultation: 'จองคำปรึกษา' },
    footer: { ...marketingEn.footer, brandDesc: 'บริษัท AI, ระบบอัตโนมัติ และโครงสร้างพื้นฐานดิจิทัลสำหรับธุรกิจยุคใหม่', company: 'บริษัท', companyProfile: 'โปรไฟล์บริษัท', technology: 'เทคโนโลยี', useCases: 'กรณีใช้งาน', platforms: 'แพลตฟอร์ม', allPlatforms: 'แพลตฟอร์มทั้งหมด', resources: 'ทรัพยากร', research: 'วิจัย', blog: 'บล็อก', privacy: 'นโยบายความเป็นส่วนตัว' },
    language: { label: 'ภาษา' },

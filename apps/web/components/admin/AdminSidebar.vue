<template>
  <aside class="flex flex-col w-56 shrink-0 h-full border-r" style="background: #111; border-color: rgba(255,255,255,0.07);">
    <!-- Logo -->
    <div class="px-4 py-4 border-b flex items-center gap-2.5" style="border-color: rgba(255,255,255,0.07);">
      ...
      <span class="font-semibold text-sm text-white">Autobot Admin</span>
    </div>

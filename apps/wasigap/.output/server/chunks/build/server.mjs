...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-ljKCGNC5.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DZ5yd53M.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-BLMzqN_7.mjs')
  },
  {
    name: "pricing",
    path: "/pricing",
    component: () => import('./pricing-C8Q-WFz5.mjs')
  },
  {
    name: "startup",
    path: "/startup",
    component: () => import('./startup-DjyvR1TM.mjs')
  },
  {
    name: "features",
    path: "/features",
    component: () => import('./features-DKRohEpa.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-CbYSXv2Y.mjs')
  },
  {
    name: "terms-of-service",
    path: "/terms-of-service",
    component: () => import('./terms-of-service-BFBTybQ0.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B2kR4X2g.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CdnA2mBO.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DBhIKtOc.mjs'));

...
echo "3. cd /opt/autobot && docker compose -f docker-compose.deploy.yml up -d --build"
echo "4. docker compose -f docker-compose.deploy.yml exec api /server migrate"
echo "5. docker compose -f docker-compose.deploy.yml exec api /server seed"

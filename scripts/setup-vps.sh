...
echo "2. Upload the prepared dist/vps bundle to /opt/autobot/"
echo "3. docker load -i images/autobot-api-cp.tar"
echo "4. docker load -i images/autobot-web-cp.tar"
echo "5. cd /opt/autobot && docker compose -f docker-compose.cp.yml up -d"
echo "6. docker compose -f docker-compose.cp.yml exec api /server migrate"
echo "7. docker compose -f docker-compose.cp.yml exec api /server seed"

...
export default function SignUpPage() {
  ...
  if (success) {
    return (
      <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 px-4">
        ...
        <div className="relative z-10 w-full max-w-md text-center">
          <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-10">
            ...
            <Link href="/auth/signin">
              <Button className="w-full bg-gradient-to-r from-[#116366] to-[#14b8a6] hover:from-[#0d4d50] hover:to-[#116366] text-white font-semibold">
                Go to Sign In
              </Button>
            </Link>
          </div>
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 py-12 px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Join Autobot Wijaya Solution today</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">Min 8 chars with uppercase, lowercase, number, and special character.</p>
            </div>
        ...
        <p className="text-center mt-6 text-gray-500 text-sm">
          ...
          <Link href="/auth/signin" className="text-[#116366] hover:text-[#14b8a6] font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </div>
